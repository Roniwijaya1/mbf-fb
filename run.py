...
class ngentod:
	...
	def login_mbasic(self,user,pw):
		...
		data.update({"email":user,"pass":pw,"bi_xrwh":"0","_fb_noscript":"true"})
		memek=ses.post("https://mbasic.facebook.com/login/device-based/regular/login/?refsrc=https%3A%2F%2Fmbasic.facebook.com%2Flogin%2F%3Fref%3Ddbl&lwv=100&ref=dbl",data=data)
